...
export const fieldClass =
  "w-full min-h-11 border-2 border-field-border bg-panel px-3 py-2.5 text-body text-foreground outline-none transition-colors placeholder:text-muted focus:border-accent aria-[invalid=true]:border-danger";
