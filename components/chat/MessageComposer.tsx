      ...
      >
        ...
        <div className="relative min-w-0 flex-1">
          ...
          <textarea
            ...
            autoComplete="off"
            className={cn(
              "block max-h-36 min-h-11 w-full resize-none rounded-[22px] border-2 border-field-border bg-background px-4 shadow-[var(--shadow-inset)] py-[10px] text-body leading-[1.45]",
